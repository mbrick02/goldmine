<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>store_item_colors/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL STORE ITEM COLORS</button></a> 
                <a href="<?= BASE_URL ?>store_item_colors/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('store_item_colors/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a store item color record.  This cannot be undone. <br>
...
<div class="w3-third w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            <div class="w3-container primary">
                <h4>Store Item Color Details</h4>
            </div>
            <div class="edit-block-content">
              <div class="w3-border-bottom"><b>Item Color:</b> <span class="w3-right w3-text-grey"><?= $item_color ?></span></div>              
            </div>
        </div>
    </div>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/store_item_colors';
    var params = {
...
function fetchAvailableRecords(results, relationshipModule) {
    ...
    var params = {
        callingModuleName: 'store_item_colors',
        updateId: <?= $update_id ?>,
        selectedRecords,
...
function submitAssoc(relationshipModule) {
    ...
    var params =  {
        ...
        requestCode: "SAS",
        relationshipModule,
        callingModule: 'store_item_colors',
        thenRun: 'repopulate'
    }
